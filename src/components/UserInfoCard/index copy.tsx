...
const UserInfoCard: React.FC<UserInfoCardProps> = ({ userData, onClick }) => {
	...
	const styleButton =
		" text-white m-2 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline";
		...
		<div className="font-sans text-xs font-bold text-center text-gray-500 uppercase align-middle transition-all rounded-lg select-none disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none ">
			...
			<div className="mt-4">
				<button
					...
					className={
						"bg-yellow-500 hover:bg-yellow-700 " + styleButton
					}
				>
					Editar usuário
				</button>
				<button
					...
					className={"bg-red-500 hover:bg-red-700 " + styleButton}
				>
					Apagar usuário
				</button>
			</div>
